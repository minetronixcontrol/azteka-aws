...
class SecondStep extends React.Component {
    ...
    handleSelectAsiento(e){
        ...
        let asiento = id.toString();

        window.console.log('state', this.state[`selected${asiento}`]);

        if(!this.state[`selected${asiento}`]){
            fetch(`/api/AsignarViajes/${idViaje}/${asiento}/${idVendedor}/Hola`, {
                method: 'PUT',
            ...
            .then(data => {
                ...
                if(promiseData.update != null){
                    this.setState({
                        [`selected${asiento}`]: true
                    });
                    generalData.asientosSelected[`selected${asiento}`] = true;
                }else{
                    alert('El asiento está ocupado');
                    this.setState({
                        [`selected${asiento}`]: false
                    });
                    generalData.asientosSelected[`selected${asiento}`] = false;
                }
            }).catch(err => {
                setTimeout(() => {
                    this.setState({
            ...
            fetch(`/api/AsignarViajes/${idViaje}/false/${asiento}/${idVendedor}/hola`, {
                method: 'PUT',
